...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   B0toX3872K0s(TTree *tree=0);
   virtual ~B0toX3872K0s();
...
#ifdef B0toX3872K0s_cxx
B0toX3872K0s::B0toX3872K0s(TTree *tree) : fChain(0) 
{
...
B0toX3872K0s::~B0toX3872K0s()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t B0toX3872K0s::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t B0toX3872K0s::LoadTree(Long64_t entry)
{
...
void B0toX3872K0s::Init(TTree *tree)
{
...
void B0toX3872K0s::Show(Long64_t entry)
{
...
Int_t B0toX3872K0s::Cut(Long64_t entry)
{
