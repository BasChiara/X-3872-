...
TString outFile_path = "/afs/cern.ch/user/c/cbasile/CMSSW-10-6-20-Analysis/src/BParkNANO/B0toX3872K0s/results/TMVAoutputs.root"; 
...
// This loads the library
   ...
   //dataloader->AddSpectator( "spec2 := var1*3",  "Spectator 2", "units", 'F' );
	...
	if (Use["MLP"])
		factory->BookMethod( dataloader, TMVA::Types::kMLP, "MLP", "H:!V:NeuronType=tanh:VarTransform=N:NCycles=200:HiddenLayers=N-1,N-4:TestRate=1:Sampling=1:UseRegulator" );
	...
	if (Use["DNN_CPU"] or Use["DNN_GPU"]) {
		// General layout.
		TString layoutString ("Layout=RELU|64,RELU|64,RELU|32,LINEAR");
